...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Jonathan Magliano";
    private static final String CONTACT_GITHUB = "https://github.com/jonathanmagliano";
    private static final String CONTACT_EMAIL = "LinkedIn: jonathanmagliano";
